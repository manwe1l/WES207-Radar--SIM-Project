...
current_tx = random.choice(startup_tx)
current_health = "OK"
current_alarm = "0"
...
def log_row(event_type, cid, mode, tx, health, alarm, rssi, snr, raw_packet):
    """Save one log row."""
...
ttk.Label(top, text="Command RSSI:").grid(row=2, column=0, padx=5, pady=5, sticky="w")
ttk.Label(top, textvariable=rssi_var).grid(row=2, column=1, padx=5, pady=5, sticky="w")

ttk.Label(top, text="Command SNR:").grid(row=2, column=2, padx=5, pady=5, sticky="w")
ttk.Label(top, textvariable=snr_var).grid(row=2, column=3, padx=5, pady=5, sticky="w")

ttk.Label(top, text="Last Update:").grid(row=3, column=0, padx=5, pady=5, sticky="w")
ttk.Label(top, textvariable=last_update_var).grid(row=3, column=1, padx=5, pady=5, sticky="w")
...
ttk.Label(mid, textvariable=command_packet_var, wraplength=800).grid(row=1, column=0, padx=5, pady=5, sticky="w")
